...
CAD_TOOL_CAPABILITIES: Dict[str, ToolCapability] = {
    "create_construction_plane": ToolCapability(
        ...
        build123d_reason="build123d plane creation is not translated yet; current adapter supports only datum sketch planes.",
    ),
    ...
    "add_line": ToolCapability(
        ...
        category="sketch",
        build123d_status="unsupported",
        build123d_reason="Line sketch geometry is represented in IR but not yet emitted by the build123d translator.",
    ),
    "add_arc": ToolCapability(
        ...
        category="sketch",
        build123d_status="unsupported",
        build123d_reason="Arc sketch geometry is represented in IR but not yet emitted by the build123d translator.",
    ),
    ...
    "revolve_profile": ToolCapability(
        ...
        category="solid_feature",
        build123d_status="unsupported",
        build123d_reason="Revolve IR exists and Fusion translates it, but build123d revolve emission is not implemented yet.",
    ),
    "create_loft": ToolCapability(
        ...
        category="solid_feature",
        build123d_status="unsupported",
        build123d_reason="Loft IR exists and Fusion translates it, but build123d loft emission is not implemented yet.",
    ),
    "apply_fillet": ToolCapability(
        ...
        build123d_status="unsupported",
        build123d_reason="Fillet requires portable edge selectors before build123d can translate it safely.",
    ),
    "apply_chamfer": ToolCapability(
        ...
        category="finishing_feature",
        build123d_status="unsupported",
        build123d_reason="Chamfer requires portable edge selectors before build123d can translate it safely.",
    ),
    "create_shell": ToolCapability(
        ...
        category="finishing_feature",
        build123d_status="unsupported",
        build123d_reason="Shell requires portable face/body selectors and target-specific shell semantics before translation.",
    ),
    "create_simple_hole": ToolCapability(
        ...
        build123d_status="unsupported",
        build123d_reason="Hole IR exists, but build123d subtractive hole construction from face selectors is not implemented yet.",
    ),
    "create_counterbore_hole": ToolCapability(
        ...
        category="hole_thread_feature",
        build123d_status="unsupported",
        build123d_reason="Counterbore IR exists, but build123d stepped-hole construction from face selectors is not implemented yet.",
    ),
    "create_tapped_hole": ToolCapability(
        ...
        category="hole_thread_feature",
        build123d_status="unsupported",
        build123d_reason="Tapped-hole manufacturing semantics need a build123d geometry/metadata policy before translation.",
    ),
    "create_external_thread": ToolCapability(
        ...
        category="hole_thread_feature",
        build123d_status="unsupported",
        build123d_reason="External thread semantics need a build123d geometry/metadata policy before translation.",
    ),
