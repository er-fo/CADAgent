...
5. Navigate to the extracted folder and locate the `Space_v23` directory
...
3. **Copy the add-in:**
   - Copy the entire `Space_v23` folder to this location
   - The final path should be: `%APPDATA%\Autodesk\Autodesk Fusion 360\API\AddIns\Space_v23\`
...
3. **Copy the add-in:**
   - Copy the entire `Space_v23` folder to this location
   - The final path should be: `~/Library/Application Support/Autodesk/Autodesk Fusion 360/API/AddIns/Space_v23/`
